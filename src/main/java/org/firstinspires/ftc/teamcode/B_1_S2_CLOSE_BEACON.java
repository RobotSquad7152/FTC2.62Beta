 ...
 */
@Autonomous(name = "RS: B_1_S2_CLOSE_BEACON", group = "Claire")


public class B_1_S2_CLOSE_BEACON extends RSLinearOpMode
{
...
/*        do
    ...
    //    sleep(300);
       ...
       /* int stepnum2 = 2;
        ...
        robot.DriveForward(.45, 50);

        telemetry.addData("gyro Heading ", robot.GetCurrentHeading());
        telemetry.update();
        sleep(1000);
        ...
        targetrobotxpos = legosLeftTargetX;
        if (robot.isZTEphone())
